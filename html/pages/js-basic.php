<?php
    $header = str_replace("{[header]}", "<header class='headerjs'></header>", file_get_contents('../templates/header.html'));
    echo $header;
?>
<!--CONTENT-->
	<div class="wrapper">
		...
		<p class="exercise">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Distinctio quasi vero ab nulla officia, velit eveniet cum porro non dolorum est magnam adipisci placeat nam voluptatibus eaque molestiae, odio, quis!</p>
        <p class="exercise">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat cupiditate numquam sequi quibusdam, distinctio doloremque iste pariatur quasi voluptatum exercitationem eum aut aperiam quo. Dolorem necessitatibus, corporis quasi dignissimos nobis!</p>
        <p class="exercise">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat cupiditate numquam sequi quibusdam, distinctio doloremque iste pariatur quasi voluptatum exercitationem eum aut aperiam quo. Dolorem necessitatibus, corporis quasi dignissimos nobis!</p>
        <p class="exercise">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat cupiditate numquam sequi quibusdam, distinctio doloremque iste pariatur quasi voluptatum exercitationem eum aut aperiam quo. Dolorem necessitatibus, corporis quasi dignissimos nobis!</p>
        <p class="exercise">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat cupiditate numquam sequi quibusdam, distinctio doloremque iste pariatur quasi voluptatum exercitationem eum aut aperiam quo. Dolorem necessitatibus, corporis quasi dignissimos nobis!</p>
        <p class="exercise">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat cupiditate numquam sequi quibusdam, distinctio doloremque iste pariatur quasi voluptatum exercitationem eum aut aperiam quo. Dolorem necessitatibus, corporis quasi dignissimos nobis!</p>
